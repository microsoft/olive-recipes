# Qwen-Qwen3-4B-Thinking-2507 — WEBGPU optimization

This folder contains Olive recipes for optimizing Qwen-Qwen3-4B-Thinking-2507 targeting the WebGPU EP.

## What this folder is for

- Execution Provider: WebGPU EP
- Typical precision: INT4 + INT8 mixed precision by default
- Example recipe filename: Qwen-Qwen3-4B-Thinking-2507_webgpu_int4_int8_kquant_mixed.json
...
3) Run Olive to build/optimize the model
   - olive run --config Qwen-Qwen3-4B-Thinking-2507_webgpu_int4_int8_kquant_mixed.json
...
This README was auto-generated for the WEBGPU EP of Qwen-Qwen3-4B-Thinking-2507.
