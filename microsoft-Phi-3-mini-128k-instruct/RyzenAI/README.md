...
|:---------------------------------------------------|:----------------------------------|
| `microsoft/Phi-3-mini-128k-instruct`                 | `Phi-3-mini-128k-instruct_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/microsoft-Phi-3-mini-128k-instruct/RyzenAI
...
olive run --config Phi-3-mini-128k-instruct_quark_ryzenai_llm.json
```
