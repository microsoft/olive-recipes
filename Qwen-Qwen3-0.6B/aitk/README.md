...
This repository demonstrates the optimization of the [Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B) model using **post-training quantization (PTQ)** techniques. The optimization process is divided into these workflows:
