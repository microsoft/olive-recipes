...
| :--------------------------------- | :------------------------------ |
| `Qwen/Qwen2-7B`       | `Qwen2-7B_quark_ryzenai_llm.json` |
...
```bash
cd olive-recipes/Qwen-Qwen2-7B/RyzenAI
...
```bash
# Qwen2-7B
olive run --config Qwen2-7B_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Qwen2-7B-rai/`
