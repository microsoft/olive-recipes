...
|:---------------------------------------------------|:----------------------------------|
| `microsoft/Phi-3-mini-4k-instruct`                 | `Phi-3-mini-4k-instruct_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/microsoft-Phi-3-mini-4k-instruct/RyzenAI
...
olive run --config Phi-3-mini-4k-instruct_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Phi-3-mini-4k-instruct-rai/`
