...
|:---------------------------------------------------|:----------------------------------|
| `microsoft/Phi-4-mini-reasoning`                   | `Phi-4-mini-reasoning_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/microsoft-Phi-4-mini-reasoning/RyzenAI
...
olive run --config Phi-4-mini-reasoning_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Phi-4-mini-reasoning-rai/`
