...
- Intel® GPU: [Qwen 2.5 Coder 14B Dynamic Shape Model](https://huggingface.co/Qwen/Qwen2.5-Coder-14B-Instruct)
...
1. [Qwen2.5-Coder-14B-instruct-gpu-context-dy.json](Qwen2.5-Coder-14B-instruct-gpu-context-dy.json)
...
Example:
```bash
olive run --config Qwen2.5-Coder-14B-instruct-gpu-context-dy.json
```
or run simply with python code:

```python
from olive import run
workflow_output = run("Qwen2.5-Coder-14B-instruct-gpu-context-dy.json")
```
...
```bash
python model-chat.py -e follow_config -v -g -m models/Qwen2.5_Coder_14B_instruct_gpu_context_dy/model/
```