...
|:--------------------------------------------------|:----------------------------------|
| `codellama/CodeLlama-7b-Instruct-hf`                | `CodeLlama-7b-Instruct-hf_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/codellama-CodeLlama-7b-Instruct-hf/RyzenAI
...
olive run --config CodeLlama-7b-Instruct-hf_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/CodeLlama-7b-Instruct-hf-rai/`
