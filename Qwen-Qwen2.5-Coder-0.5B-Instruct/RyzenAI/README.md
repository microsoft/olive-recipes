...
| :--------------------------------- | :------------------------------ |
| `Qwen/Qwen2.5-Coder-0.5B-Instruct`       | `Qwen2.5-Coder-0.5B-Instruct_quark_ryzenai_llm.json` |
...
```bash
cd olive-recipes/Qwen-Qwen2.5-Coder-0.5B-Instruct/RyzenAI
...
olive run --config Qwen2.5-Coder-0.5B-Instruct_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Qwen2.5-Coder-0.5B-Instruct-rai/`
