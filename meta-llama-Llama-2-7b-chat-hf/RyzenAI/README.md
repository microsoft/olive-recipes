...
|:----------------------------------------|:----------------------------------|
| `meta-llama/Llama-2-7b-chat-hf`         | `Llama-2-7b-chat-hf_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/meta-llama-Llama-2-7b-chat-hf/RyzenAI
...
```bash
# Llama-2-7b-chat-hf
olive run --config Llama-2-7b-chat-hf_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Llama-2-7b-chat-hf-rai/`
