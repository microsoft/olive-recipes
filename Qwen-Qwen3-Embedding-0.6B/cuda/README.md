...
- Recipe: `Qwen-Qwen3-Embedding-0.6B_cuda_fp32.json` (build only), `Qwen-Qwen3-Embedding-0.6B_cuda_fp32_with_eval.json` (build + evaluate)
...
```bash
olive run --config Qwen-Qwen3-Embedding-0.6B_cuda_fp32_with_eval.json
```
