...
| :-------------------------------- | :------------------------------ |
| `microsoft/Phi-3.5-mini-instruct` | `Phi-3.5-mini-instruct_quark_ryzenai_llm.json` |
...
```bash
cd olive-recipes/microsoft-Phi-3.5-mini-instruct/RyzenAI
...
olive run --config Phi-3.5-mini-instruct_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Phi-3.5-mini-instruct-rai/`
