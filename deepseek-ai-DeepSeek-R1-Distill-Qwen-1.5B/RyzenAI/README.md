...
|:---------------------------------------------------------|:------------------------------------------------------|
| `deepseek-ai/DeepSeek-R1-Distill-Llama-8B`               | `DeepSeek-R1-Distill-Llama-8B_quark_ryzenai_llm.json`    |
| `deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B`              | `DeepSeek-R1-Distill-Qwen-1.5B_quark_ryzenai_llm.json`   |
| `deepseek-ai/DeepSeek-R1-Distill-Qwen-7B`                | `DeepSeek-R1-Distill-Qwen-7B_quark_ryzenai_llm.json`     |
...
```bash
cd olive-recipes/deepseek-ai-DeepSeek-R1-Distill-Qwen-1.5B/RyzenAI
...
olive run --config DeepSeek-R1-Distill-Llama-8B_quark_ryzenai_llm.json

# DeepSeek-R1-Distill-Qwen-1.5B
olive run --config DeepSeek-R1-Distill-Qwen-1.5B_quark_ryzenai_llm.json

# DeepSeek-R1-Distill-Qwen-7B
olive run --config DeepSeek-R1-Distill-Qwen-7B_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/DeepSeek-R1-Distill-Llama-8B-rai/`
