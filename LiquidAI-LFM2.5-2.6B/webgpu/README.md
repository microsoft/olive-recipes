...
| --- | --- | --- | --- |
| `_webgpu_int4.json` | 2.25 GiB | 0.170 | 81.1% |
| `_webgpu_fp16_int4.json` | 2.27 GiB | 0.283 | 75.6% |
| llama.cpp Q4_K_M | 1.56 GiB | 0.154-0.155 | 81.3-81.4% |
| llama.cpp Q8_0 | 2.68 GiB | 0.0012-0.0029 | 97.5-98.3% |

INT4 trails Q4_K_M: 10% more KLD than llama.cpp's CPU backend (0.170 against 0.155), at 1.4x its
...
`_webgpu_fp16_int4.json` is the least accurate recipe here despite being the larger one (KLD 0.283
against 0.170): plain RTN costs more than the FP16 LM head saves.
