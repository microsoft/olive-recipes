# LiquidAI-LFM2.5-VL-1.6B — CUDA optimization
...
```
olive run --config LiquidAI-LFM2.5-VL-1.6B_cuda_int4.json
```
...
```
olive run --config LiquidAI-LFM2.5-VL-1.6B_cuda_int8.json
```
...
```
olive run --config LiquidAI-LFM2.5-VL-1.6B_cuda_vision_int8.json
```
...
| --- | --- | --- | --- |
| `_cuda_int4.json` | 0.91 GiB | 0.049 | 88.9% |
| `_cuda_int8.json` | 1.31 GiB | 0.0008 | 98.6% |
...
INT4 trails Q4_K_M: 22% more KLD than llama.cpp's CPU backend (0.049 against 0.040), at 1.3x its
