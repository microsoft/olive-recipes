...
| :--------------------------------- | :------------------------------ |
| `Qwen/Qwen2.5-3B`       | `Qwen2.5-3B_quark_ryzenai_llm.json` |
...
```bash
cd olive-recipes/Qwen-Qwen2.5-3B/RyzenAI
...
```bash
# Qwen2.5-3B-Instruct
olive run --config Qwen2.5-3B_quark_ryzenai_llm.json
```

✅ Optimized model saved in: `models/Qwen2.5-3B-rai/`
