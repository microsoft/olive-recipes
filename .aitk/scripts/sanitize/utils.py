...
# Canonical winml.py source. The path is relative to the project's aitk folder
# (matches the CopyConfig `src` format).
WINML_SRC = "../../deepseek-ai-DeepSeek-R1-Distill-Qwen-1.5B/aitk/winml.py"


def winml_copy_src_for(_model_id: str) -> str:
    return WINML_SRC
