...
|:--------------------------------------------------|:----------------------------------|
| `mistralai/Mistral-7B-Instruct-v0.2`              | `Mistral-7B-Instruct-v0.2_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/mistralai-Mistral-7B-Instruct-v0.2/RyzenAI
...
✅ Optimized model saved in: `models/Mistral-7B-Instruct-v0.2-rai/`
