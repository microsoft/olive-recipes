# Mistral-7B-Instruct-v0.2 Model Optimization

This repository demonstrates the optimization of the [Mistral-7B-Instruct-v0.2](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2) model using **post-training quantization (PTQ)** techniques.
...
✅ Optimized model saved in: `models/Mistral-7B-Instruct-v0.2/`
