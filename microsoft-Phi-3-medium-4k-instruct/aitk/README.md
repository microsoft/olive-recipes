...
This folder contains a sample use case of Olive to optimize a Phi-3-medium-instruct models using OpenVINO tools.

- Intel® GPU: [Phi 3 medium 4k Instruct Dynamic Shape Model](https://huggingface.co/microsoft/Phi-3-medium-4k-instruct)
