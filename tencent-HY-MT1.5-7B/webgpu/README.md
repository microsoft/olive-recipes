# tencent-HY-MT1.5-7B — WebGPU optimization

This folder contains Olive recipes for optimizing tencent-HY-MT1.5-7B targeting the WebGPU EP.

## What this folder is for

- Execution Provider: WebGPU EP
- Typical precision: INT4 precision by default
- Example recipe filename: tencent-HY-MT1.5-7B_webgpu_int4.json
...
3) Run Olive to build/optimize the model
   - olive run --config tencent-HY-MT1.5-7B_webgpu_int4.json
...
This README was auto-generated for the WebGPU EP of tencent-HY-MT1.5-7B.
