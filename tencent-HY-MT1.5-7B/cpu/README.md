# tencent-HY-MT1.5-7B — CPU optimization

This folder contains Olive recipes for optimizing tencent-HY-MT1.5-7B targeting the CPU EP.

## What this folder is for

- Execution Provider: CPU EP
- Typical precision: INT4 precision by default
- Example recipe filename: tencent-HY-MT1.5-7B_cpu_int4.json
...
3) Run Olive to build/optimize the model
   - olive run --config tencent-HY-MT1.5-7B_cpu_int4.json
...
This README was auto-generated for the CPU EP of tencent-HY-MT1.5-7B.
