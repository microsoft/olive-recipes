...
This repository demonstrates the optimization of the [Qwen3-8B](https://huggingface.co/Qwen/Qwen3-8B) model using **post-training quantization (PTQ)** techniques. This code was originally run on Ubuntu 22.04, use the same OS for maximum compatibility.
...
Optimized model saved in: `models/qwen3_8B/`
