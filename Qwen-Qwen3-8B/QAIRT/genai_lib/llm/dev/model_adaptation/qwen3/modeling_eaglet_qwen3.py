...
__all__ = ["Qwen3EagletDraftModel", "Qwen3Eaglet2DraftModel", "Qwen3EagletDecoderLayer"]

class Qwen3EagletDraftModel(BaseDraftModel):
    def __init__(self, config):
        super().__init__(
            config, decoder_cls=Qwen3EagletDecoderLayer, norm_cls=Qwen3RMSNorm, dual_fc=True
        )
