...
__all__ = ["LlamaEagletDraftModel", "LlamaEagletDecoderLayer", "LlamaEaglet2DraftModel"]


class LlamaEagletDraftModel(BaseDraftModel):
    def __init__(self, config, **kwargs):
        super().__init__(config=config, decoder_cls=LlamaEagletDecoderLayer,**kwargs)


class LlamaEagletDecoderLayer(nn.Module):
...
class LlamaEaglet2DraftModel(Eaglet2BaseDraftModel):
    def __init__(self, config):
        super().__init__(config=config, decoder_cls=LlamaEagletDecoderLayer)
