...
| --- | --- | --- | --- |
| `_cuda_int4.json` | 2.01 GiB | 0.028 | 91.1% |
| `_cuda_int8.json` | 2.93 GiB | 0.0011 | 98.3% |
| llama.cpp Q4_K_M | 1.56 GiB | 0.024-0.025 | 92.0-92.3% |
| llama.cpp Q8_0 | 2.68 GiB | 0.0002-0.0005 | 98.8-99.2% |

INT8 is close to Q8_0 but not level with it (0.0011 against 0.0005 on llama.cpp's CPU backend); the
CUDA EP computes in FP16.

INT4 trails Q4_K_M: 11% more KLD than llama.cpp's CPU backend (0.028 against 0.025), at 1.3x its
