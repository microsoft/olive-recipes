# LiquidAI-LFM2.5-VL-3B — CPU optimization
...
```
olive run --config LiquidAI-LFM2.5-VL-3B_cpu_int4.json
```
...
```
olive run --config LiquidAI-LFM2.5-VL-3B_cpu_int8.json
```
...
```
olive run --config LiquidAI-LFM2.5-VL-3B_cpu_vision_int8.json
```
...
| --- | --- | --- | --- |
| `_cpu_int4.json` | 2.16 GiB | 0.027 | 91.2% |
| `_cpu_int8.json` | 3.09 GiB | 0.0005 | 98.8% |
| llama.cpp Q4_K_M | 1.56 GiB | 0.024-0.025 | 92.0-92.3% |
| llama.cpp Q8_0 | 2.68 GiB | 0.0002-0.0005 | 98.8-99.2% |

INT8 matches Q8_0 (0.0005 against 0.0005).

INT4 trails Q4_K_M: 9% more KLD than llama.cpp's CPU backend (0.027 against 0.025), at 1.4x its
