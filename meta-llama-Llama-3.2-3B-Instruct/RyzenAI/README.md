...
|:--------------------------------------------------|:----------------------------------|
| `meta-llama/Llama-3.2-3B-Instruct`                | `Llama-3.2-3B-Instruct_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/meta-llama-Llama-3.2-3B-Instruct/RyzenAI
...
✅ Optimized model saved in: `models/Llama-3.2-3B-Instruct-rai/`
