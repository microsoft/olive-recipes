...
This example demonstrates how to convert [Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B) vision-language model to ONNX format using Olive and run inference with ONNX Runtime GenAI.
