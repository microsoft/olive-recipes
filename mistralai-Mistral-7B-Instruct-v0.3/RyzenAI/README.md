...
|:--------------------------------------------------|:----------------------------------|
| `mistralai/Mistral-7B-Instruct-v0.3`              | `Mistral-7B-Instruct-v0.3_quark_ryzenai_llm.json`  |
...
```bash
cd olive-recipes/mistralai-Mistral-7B-Instruct-v0.3/RyzenAI
...
✅ Optimized model saved in: `models/Mistral-7B-Instruct-v0.3-rai/`
