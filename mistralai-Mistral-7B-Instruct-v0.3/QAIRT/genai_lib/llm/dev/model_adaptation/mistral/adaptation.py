...
# =============================================================================
# Portions adapted from the HuggingFace Transformers Mistral implementation.
# Licensed under the Apache License, Version 2.0.
# =============================================================================

"""This file provides adaptations to the Mistral model optimised for HTP backend execution."""
...
class QcMistralAttention(MistralAttention):
    """Multi-headed attention adapted for HTP backend inference."""

    def __init__(self, config: MistralConfig, layer_idx: int):
        super(QcMistralAttention, self).__init__(config, layer_idx)
...
class QcMistralForCausalLM(MistralForCausalLM):
    """
    Subclass of MistralForCausalLM adapted for HTP backend inference.

    Handles num_logits_to_keep compatibility and cache_index → cache_position
    conversion needed for static-shape ONNX export.
    """
    ...
    def forward(
        ...
        if cache_index is not None:
            assert hasattr(self, "cache_tensor"), (
                "QcMistralForCausalLM doesn't have attribute \"cache_tensor\"; "
...
def DynamicCache_to_legacy_cache(self):
    """Converts DynamicCache to legacy tuple format for backward compatibility."""
    legacy_cache = ()
