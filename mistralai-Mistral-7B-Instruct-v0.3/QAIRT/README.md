# Mistral-7B-Instruct-v0.3 Model Optimization

This directory demonstrates the optimization of the [Mistral-7B-Instruct-v0.3](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3) model using various AIMET quantization techniques.

## Overview

This workflow utilizes a Mistral-7B-Instruct-v0.3 script to perform AdaScale weight optimization followed by AIMET quantization.
...
1. `mistralai/Mistral-7B-Instruct-v0.3` is an open-access model (Apache-2.0) — no Hugging Face gating or authentication is required to download it.
