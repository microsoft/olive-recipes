# LiquidAI-LFM2.5-230M — CPU optimization
...
```
olive run --config LiquidAI-LFM2.5-230M_cpu_int4.json
```
...
```
olive run --config LiquidAI-LFM2.5-230M_cpu_int8.json
```
...
| --- | --- | --- | --- |
| `_cpu_int4.json` | 0.46 GiB | 0.114 | 80.3% |
| `_cpu_int8.json` | 0.34 GiB | 0.0017 | 97.3% |
| llama.cpp Q4_K_M | 0.14 GiB | 0.092-0.099 | 81.1-81.7% |
| llama.cpp Q8_0 | 0.23 GiB | 0.0007-0.0017 | 97.3-98.2% |

INT8 matches Q8_0 (0.0017 against 0.0017).

INT4 trails Q4_K_M: 15% more KLD than llama.cpp's CPU backend (0.114 against 0.099), at 3.3x its
...
weights, where Q4_K packs 6-bit scales into 256-weight super-blocks. On this model that makes INT4
larger than INT8 (0.34 GiB).
