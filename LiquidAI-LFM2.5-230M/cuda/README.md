...
| --- | --- | --- | --- |
| `_cuda_int4.json` | 0.31 GiB | 0.110 | 80.5% |
| `_cuda_int8.json` | 0.31 GiB | 0.0017 | 97.2% |
...
INT4 trails Q4_K_M: 11% more KLD than llama.cpp's CPU backend (0.110 against 0.099), at 2.2x its
