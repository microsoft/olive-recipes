# Qwen-Qwen3-32B — CPU optimization

This folder contains Olive recipes for optimizing Qwen-Qwen3-32B targeting the CPU EP.

## What this folder is for

- Execution Provider: CPU EP
- Typical precision: INT4 + INT8 mixed precision by default
- Example recipe filename: Qwen-Qwen3-32B_cpu_int4_int8_kquant_mixed.json
...
3) Run Olive to build/optimize the model
   - olive run --config Qwen-Qwen3-32B_cpu_int4_int8_kquant_mixed.json
...
This README was auto-generated for the CPU EP of Qwen-Qwen3-32B.
