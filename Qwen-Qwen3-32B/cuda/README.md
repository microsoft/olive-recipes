# Qwen-Qwen3-32B — CUDA optimization

This folder contains Olive recipes for optimizing Qwen-Qwen3-32B targeting the CUDA EP.

## What this folder is for

- Execution Provider: CUDA EP
- Typical precision: INT4 + INT8 mixed precision by default
- Example recipe filename: Qwen-Qwen3-32B_cuda_int4_int8_kquant_mixed.json
...
3) Run Olive to build/optimize the model
   - olive run --config Qwen-Qwen3-32B_cuda_int4_int8_kquant_mixed.json
...
This README was auto-generated for the CUDA EP of Qwen-Qwen3-32B.
